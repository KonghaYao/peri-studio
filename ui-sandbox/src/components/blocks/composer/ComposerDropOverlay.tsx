  ...
  return (
    <Show when={props.active}>
      <div class="composer-drop-overlay pointer-events-none absolute inset-0 z-10 grid place-items-center">
        <p id={props.describedById} class="rounded-md border border-accent-border-hover bg-surface-overlay px-3 py-2 text-12 font-medium text-accent-solid shadow-raised">
