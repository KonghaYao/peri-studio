...
export function CheckboxControl<T extends ValidComponent = 'div'>(props: PolymorphicProps<T, ControlProps<T>>) {
  ...
  return <CheckboxPrimitive.Control class={cn('h-16 w-16 shrink-0 rounded-4 border border-border-strong bg-surface data-checked:border-text-primary data-checked:bg-text-primary data-checked:shadow-[inset_0_0_0_3px_var(--surface)]', local.class)} {...rest} />;
}
