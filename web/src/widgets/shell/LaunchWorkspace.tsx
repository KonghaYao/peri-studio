...
export function LaunchWorkspace(props: LaunchWorkspaceProps) {
  ...
  return <div class="launch-workspace relative flex min-h-0 flex-1 flex-col items-center overflow-hidden px-24 pb-20 text-center max-narrow:px-10 max-narrow:pb-10">
    <div data-testid="launch-prompt" class="launch-prompt pointer-events-none absolute inset-x-20 flex -translate-y-1/2 flex-col items-center">
      <div class="launch-mark mb-24 grid place-items-center text-text-faint" aria-hidden="true">
        <Icon><path d="M6.2 13.7A5.2 5.2 0 0 1 7 4.1a5.4 5.4 0 0 1 8.2 2.2 4.7 4.7 0 0 1 .6 8.9 5 5 0 0 1-8.7 1.1 5.2 5.2 0 0 1-.9-2.6Z" /><path d="m8.2 7.2 2.6 2.8-2.6 2.8M12.2 13h2.6" /></Icon>
      </div>
      <h2 class="m-0 text-28 font-normal leading-13 -tracking-35 text-text-primary max-narrow:text-24">What do you want to build in Peri Studio?</h2>
    ...
    <Show when={activeProjects().length === 0} fallback={
      <div data-testid="launch-composer" class="launch-composer mt-auto w-full max-w-(--composer-launch-max)">
