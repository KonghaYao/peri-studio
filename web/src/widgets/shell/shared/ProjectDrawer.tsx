...
const drawerPanelClass =
  'project-drawer h-full min-h-0 min-w-0 overflow-hidden border-r border-border-faint bg-transparent max-desk:fixed max-desk:inset-y-0 max-desk:left-0 max-desk:top-0 max-desk:z-61 max-desk:h-dvh max-desk:w-(--container-drawer) max-desk:max-h-none max-desk:translate-y-0 max-desk:rounded-none max-desk:border-t-0 max-desk:shadow-none max-desk:transition-transform max-desk:duration-200';
