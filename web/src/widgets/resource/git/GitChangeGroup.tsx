...
export function GitChangeGroup(props: {
  ...
  return (
    <section class="pb-2">
      <div class="resource-group-title flex h-(--tree-row-height) items-center gap-4 px-7 text-10 font-650 uppercase tracking-4 text-text-secondary pointer-coarse:h-44">
