...
export function Markdown(props: { source: string; streaming?: boolean }) {
  ...
  return <div class="markdown-body min-w-0 text-text-primary [&>*:first-child]:mt-0 [&>*:last-child]:mb-0 [&_p]:mb-10 [&_p]:mt-0 [&_h2]:mt-18 [&_h2]:mb-7 [&_h2]:text-17 [&_h2]:leading-125 [&_h2]:tracking-[-.018em] [&_h3]:mt-18 [&_h3]:mb-7 [&_h3]:text-15 [&_h3]:leading-125 [&_h3]:tracking-[-.018em] [&_h4]:mt-18 [&_h4]:mb-7 [&_h4]:text-14 [&_h4]:leading-125 [&_h4]:tracking-[-.018em] [&_ul]:my-7 [&_ul]:mb-12 [&_ul]:list-disc [&_ul]:pl-22 [&_ol]:my-7 [&_ol]:mb-12 [&_ol]:list-decimal [&_ol]:pl-22 [&_li]:my-3 [&_li]:pl-2 [&_li>ul]:mb-0 [&_li>ol]:mb-0 [&_blockquote]:my-10 [&_blockquote]:border-l-[3px] [&_blockquote]:border-border-strong [&_blockquote]:py-2 [&_blockquote]:pl-12 [&_blockquote]:text-text-secondary [&_hr]:my-18 [&_hr]:h-px [&_hr]:border-0 [&_hr]:bg-divider [&_a]:text-link [&_a]:underline [&_a]:decoration-link-decoration [&_a]:underline-offset-3 [&_a:hover]:decoration-current">
