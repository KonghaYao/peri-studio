...
describe('tool-narration', () => {
  ...
  it('narrates files, searches and questions with user-facing verbs', () => {
    expect(narrateToolCall({ ...base, name: 'Read', kind: 'read', arguments: { file_path: '/workspace/src/main.ts', offset: 10, limit: 5 } }, { tone: 'done', statusLabel: 'Done', running: false, terminal: true })).toMatchObject({
      kind: 'read-file',
