...
const FEATURE_OWNERS = {
  prompt_status: { module: 'features/runtime/prompt-recovery-assembly.ts', prefix: 'handlePromptStatus' },
  rewind_candidates: { module: 'features/runtime/rewind-assembly.ts', prefix: 'handleRewindCandidates' },
  rewind_preview: { module: 'features/runtime/rewind-assembly.ts', prefix: 'handleRewindPreview' },
  mcp_servers: { module: 'features/mcp/mcp.ts', prefix: 'handleMcpServers' },
  mcp_oauth: { module: 'features/mcp/mcp.ts', prefix: 'handleMcpOAuth' },
  mcp_oauth_authorization: { module: 'features/mcp/mcp.ts', prefix: 'handleMcpOAuthAuthorization' },
