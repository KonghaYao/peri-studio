...
export const UserBubble: Component<{ class?: string; children: JSX.Element }> = (props) => {
  ...
  return (
    <div class={cn('flex w-full min-w-0 justify-end', local.class)} {...rest}>
      <div class="min-w-0 max-w-(--chat-bubble-max) rounded-xl border border-border-subtle bg-surface-overlay px-12 py-8 text-13 leading-normal text-content-primary">
        {local.children}
      </div>
    </div>
  );
